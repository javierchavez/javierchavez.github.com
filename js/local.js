...
//  itsnotartitscode colr thing
(function($){
    $.fn.colored = function(options) {
        var settings = $.extend({}, $.fn.colored.defaults, options || {});
            if(this.length === 0) {
                return this;    }
        ...
        var letter = $('<span>'+text.charAt(i)+'</span>').data('to-color',settings.colors[i % 4]);
            this.append(letter);    }
    ...
    $.extend($.fn.colored, {
        ...
        colorDuration: 90,
        unColorDuration: 550,
        colors: ['#ff003a','#51b749','#4a86e8','#fbe983']
        }        
    });
})(jQuery);
